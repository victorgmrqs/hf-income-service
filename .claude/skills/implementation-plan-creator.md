...
**Critérios de aceite:**
- [ ] Interfaces para IncomeRepository, GlobalBudgetRepository, ReductionGoalRepository definidas
- [ ] Projeto compila
...
### T03 — IncomeRepository (implementação)
**Estimativa:** M
**Depende de:** T01, T02
**Arquivos:**
- `internal/repository/income.go`
- `internal/repository/income_test.go` (integração com testcontainers)

**Critérios de aceite:**
- [ ] CRUD completo: Create, GetByID, ListByUserAndCompetence, Update, Delete (soft)
- [ ] Teste de integração com PostgreSQL real via testcontainers
- [ ] Regra REC-XX respeitada nas queries

**Risco:** baixo

---

### T04 — UseCase: income.Create
**Estimativa:** M
**Depende de:** T03
**Arquivos:**
- `internal/usecase/income/create.go`
- `internal/usecase/income/create_test.go`

**Critérios de aceite:**
- [ ] Valida todos os campos obrigatórios
- [ ] Retorna ErrXxx correto por regra violada (REC-0X)
- [ ] Log INFO na entrada e saída
- [ ] BusinessErrorsTotal incrementado nos cenários de erro
- [ ] Testes unitários cobrem todos os erros da matriz

**Risco:** baixo

---

[... demais tasks seguem o mesmo formato ...]
