...
| ORC-05 | Auto-ajuste ocorre no 1º dia do mês via job; teto é sempre editável manualmente | 📅 | Edição manual sobrescreve o auto-ajuste e define `auto_adjusted: false` |
